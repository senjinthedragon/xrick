...
| **Bezel** | **None**. **Atari SC1224** - the Atari ST's own monitor. **Commodore 1084S** - the classic Amiga monitor. Bezels add a touch of screen curvature, and are scaled to fill the window (full height on a wide screen) without stretching. |
...
- **xrick** by [bigorno](https://github.com/zpqrtbnk/xrick) (Stéphane Gay) - the original reverse-engineered game
