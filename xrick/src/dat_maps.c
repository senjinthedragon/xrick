...
map_t map_maps[MAP_NBR_MAPS] = {
  {0x0008, 0x008b, 0x0008, 000000, "sounds/tune0.ogg"},
  {0x0008, 0x008b, 0x0068, 0x0009, "sounds/tune1.ogg"},
  {0x0010, 0x008b, 0x0010, 0x0014, "sounds/tune2.ogg"},
  {0x0010, 0x008b, 0x0010, 0x0026, "sounds/tune3.ogg"},
  {0x0074, 0x00c8, 0x0008, 0x0026, "sounds/tune4.ogg"},
};
